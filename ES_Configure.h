...
typedef enum {
    ...
    REAR_RIGHT_MOTOR,
    FINISHED_MOVING,
    FINISHED_MOVING_LEFT_BANK,
    FINISHED_MOVING_RIGHT_BANK,
    FINISHED_TURNING,
    TAPE_ON,
    TAPE_OFF,
    TOWER_ON_TAPE,
    ...
    BUMPER_PRESSED,
    BUMPER_RELEASED,
    TANK_ON, // used for find correct side sub hsm
    TANK_OFF,
    BEACON_NOT_DETECTED,
    BEACON_DETECTED,
    BEACON_CONFIRMED,
    ...
    BEACON_SAMPLE,
    DISPENING_FINISHED,
    TRAVEL_TO_BEACON, //goes to travel to beacon substate
    GO_TO_EDGEFOLLOWING, //exit state in travel to beacon subhsm, goes to edge following sub hsm
    CHECK_IF_TOWER, //tower found in travel to beacon subhsm, goes to check if tower sub hsm
    EDGE_OBSTACLE,
    FOUND_SIDE,
    GIVE_UP,
...
static const char *EventNames[] = {
    ...
    "REAR_LEFT_MOTOR",
    "REAR_RIGHT_MOTOR",
    "FINSIHED_MOVING_FORWARD",
    "FINSIHED_MOVING_LEFT_BANK",
    "FINSIHED_MOVING_RIGHT_BANK",
    "FINISHED_TURNING",
    "TAPE_ON",
    "TAPE_OFF",
    "TOWER_ON_TAPE",
...
#define EVENT_CHECK_LIST  CheckMotors, MoveAmount
...
#define ENCODER_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
#define BUMPER_TIMER 1
#define TAPE_TIMER 2
#define CORRECT_SIDE_TIMER 3
#define TANK_TIMER 4
#define BEACON_TIMER 5
#define DISPENSER_TIMER 6
#define EDGE_TIMER 7
#define PUSH_TIMER 8
#define OBSTACLE_TIMER 9
#define SHIMMY_TIMER 10
/****************************************************************************/
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "TopLvlHSM.h"
// the name of the Init function
#define SERV_3_INIT InitHSM
// the name of the run function
#define SERV_3_RUN RunHSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "TankService.h"
// the name of the Init function
#define SERV_5_INIT InitTankService
// the name of the run function
#define SERV_5_RUN RunTankService
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public fuction prototypes
#define SERV_6_HEADER "BeaconService.h"
// the name of the Init function
#define SERV_6_INIT InitBeaconService
// the name of the run function
#define SERV_6_RUN RunBeaconService
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public fuction prototypes
#define SERV_7_HEADER "DispenserService.h"
// the name of the Init function
#define SERV_7_INIT InitDispenserService
// the name of the run function
#define SERV_7_RUN RunDispenserService
// How big should this services Queue be?
