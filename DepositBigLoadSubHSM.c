...
#define REVERSE_AMOUNT 1100 //900
#define FORWARD_ADJUST_AMOUNT 225
#define PUSH_AMOUNT 250
#define FORWARD_X_AMOUNT 75
#define TURN_AMOUNT 5
#define EDGE_TIMER_TICKS 10000
#define SHIMMY_TIMER_TICKS 200
/*******************************************************************************
...
static DepositBigLoadSubHSMState_t CurrentState = Reverse; // <- change name to match ENUM
static uint8_t MyPriority;
static uint16_t shimmyCounter;
...
uint8_t InitDepositBigLoadSubHSM(void) {
    ES_Event returnEvent;

    CurrentState = Reverse;
    returnEvent = RunDepositBigLoadSubHSM(INIT_EVENT);
...
ES_Event RunDepositBigLoadSubHSM(ES_Event ThisEvent) {
    uint8_t makeTransition = FALSE;
    DepositBigLoadSubHSMState_t nextState;
    ...
    if (makeTransition == TRUE) { // making a state transition, send EXIT and ENTRY
        ...
        RunDepositBigLoadSubHSM(EXIT_EVENT); // <- rename to your own Run function
        CurrentState = nextState;
        RunDepositBigLoadSubHSM(ENTRY_EVENT); // <- rename to your own Run function
    }
